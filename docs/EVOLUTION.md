...
- [Ветвление на одной схеме](#ветвление-на-одной-схеме)
- [Эпоха 0 — задумка](#эпоха-0--задумка)
- [Эпоха 1 — первое название, первый релиз](#эпоха-1--первое-название-первый-релиз)
- [Эпоха 2–3 — английский и настоящая универсальность](#эпоха-23--английский-и-настоящая-универсальность)
- [Эпоха 4–5 — параллельная ветка и безопасность](#эпоха-45--параллельная-ветка-и-безопасность)
- [Эпоха 6 — измеримость](#эпоха-6--измеримость)
- [Эпоха 7–8 — архитектурный рефакторинг](#эпоха-78--архитектурный-рефакторинг)
- [Эпоха 9 — компрессия](#эпоха-9--компрессия)
- [Эпоха 10 — production](#эпоха-10--production)
- [Параллельный форк — v666](#параллельный-форк--v666)
- [Что умирало по дороге](#что-умирало-по-дороге)
- [Что осталось с v0](#что-осталось-с-v0)
